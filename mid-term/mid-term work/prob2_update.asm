...
loop:
	mov.s	$f8, $f9		# x1 = x2
	add.s	$f9, $f8, $f7		# x2 = x1 + element_len
	c.lt.s	$f5, $f9		# if x2 > d
	bc1f	cal			# then calculate area
	# set size of the last rectangle
	mov.s	$f9, $f5
	sub.s	$f7, $f9, $f8		# element_len = x2 - x1	
